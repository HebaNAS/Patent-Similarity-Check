...
with DAG(
	...
	trigger_core_pipeline = TriggerDagRunOperator(task_id='trigger_core_pipeline_task', python_callable=folder_watch.main, trigger_dag_id='core_pipeline', dag=dag)
	
	trigger_core_pipeline
